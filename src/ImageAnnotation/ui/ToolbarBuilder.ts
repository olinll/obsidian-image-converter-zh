...
export class ToolbarBuilder {
    ...
    createColorSwatches(): void {
        ...
        grayScaleRow.createSpan('image-converter-annotation-tool-row-label').setText('灰度:');
        ...
        paletteRow.createSpan('image-converter-annotation-tool-row-label').setText('调色板:');
        ...
        dominantRow.createSpan('image-converter-annotation-tool-row-label').setText('主色:');
        ...
        complementaryRow.createSpan('image-converter-annotation-tool-row-label').setText('互补色:');
    ...
    private createTextBackgroundControls(container: HTMLElement): void {
        ...
        // eslint-disable-next-line obsidianmd/ui/sentence-case
        textBgContainer.createDiv('control-label').setText('文本背景:');
    ...
    private createPresetButtons(container: Element): void {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            presetButton.setAttribute('title', '点击加载，Shift+点击保存');
        }
    }
